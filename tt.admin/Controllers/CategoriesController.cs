...
namespace tt.admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ParentId,Slug,Name,Image,ShortDescription,Description,MetaTitle,MetaDescription,MetaKeywords,Sort,Status,WebIcon,MobileIcon,AttributeType")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
